...
public class loginform extends AppCompatActivity implements OnCheckedChangeListener, View.OnClickListener {
    ...
    // 定义下拉列表需要显示的文本数组
    private String[] starArray = {"用户", "个人", "18990219杜雨曼"};
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) { // 点击了“忘记密码”按钮
            ...
            Log.d("login", "onClick: 标志" + rb_scale.isChecked());
            if (rb_scale.isChecked()) { // 密码方式校验
                Log.d("login", "onClick: 进入" + et_phone.getText().toString());
                // 根据手机号码到数据库中查询用户记录
