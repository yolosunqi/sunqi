...
import com.example.homeworkfour.bean.UserInfo;
import com.example.homeworkfour.database.UserDBHelper;
import com.example.homeworkfour.util.DateUtil;
import com.example.homeworkfour.util.ViewUtil;
...
public class register extends AppCompatActivity implements View.OnClickListener {
    ...
    public void intentloginform() {
        Intent intent = new Intent(this, LoginForgetActivity.class);//跳转到登录页面
